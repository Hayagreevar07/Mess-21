...
export default function Sidebar({ isOpen = false, onClose, pendingTaskCount = 0 }: SidebarProps) {
  ...
  const navItems = [
    ...
    { to: '/messages', icon: MessageSquare, label: 'Chat', roles: ['admin', 'representative', 'member'] },
    { to: '/notes', icon: MessageSquare, label: 'Notes', roles: ['admin', 'representative', 'member'] },
    { to: '/queries', icon: MessageSquare, label: 'Support', roles: ['admin', 'representative', 'member'] },
