...
export default function MessagesPage() {
  ...
  // Active Chat View
  return <div className="page-container" style={{ display: 'flex', flexDirection: 'column', height: '100%', position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'var(--bg-base)' }}>
        {/* Chat Header */}
